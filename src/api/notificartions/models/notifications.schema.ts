import { INotificationDocument, INotification } from '@notification/interfaces/notifications.interface';
import { notificationService } from '@service/db/notifications.service';
